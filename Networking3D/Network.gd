extends Node # This Script is from GDQuest on GitHub

const DEFAULT_IP = '192.168.1.41'
const DEFAULT_PORT = 5000
const MAX_PLAYERS = 5

var players = { }
var self_data = { name = '', position = Vector3(0, 0, 0), direction = Vector3(0, 0, 0), }
...
remote func _send_player_info(id, info):
	...
	new_player.init(info.name, info.position, info.direction, true)

func update_position(id, position, direction):
